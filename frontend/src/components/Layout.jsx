    ...
    <div className="shell">
      ...
      <header className="mtop">
        <div className="mtop-saludo">
          {nombre ? `Hola, ${nombre}` : <span className="mtop-brand"><Logo size={32} /> <span>Ya<span className="wm-or">Fact</span></span></span>}
        </div>
      ...
      {menuAbierto && (
        <div className="menu-overlay">
          <div className="menu-head">
            <div className="brand"><Logo size={32} /> <span>Ya<span className="wm-or">Fact</span></span></div>
